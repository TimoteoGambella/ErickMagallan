...
import pip6 from "../../assets/pip-6.svg";
import pip7 from "../../assets/pip-7.svg";
import pip8 from "../../assets/pip-8.svg";
    ...
    const preguntas = [
        {
            ...
            description: [
                ...
                ['Amenaza de separación.', 'Disfunciones sexuales.', 'Desacuerdos insuperables.', 'Ya no hay diversión ni humor.', 'Existen secretos y mentiras.', 'Instatisfacción y frustración.', 'Envidia y lucha de poder.', 'Relaciones extramaritales.']
            ]
        },
        {
        ...
        },
        {
            ...
            description: [(
                <p>
                    Acudir a <span className="font-bold">Psicoterapia de Pareja</span> con un profesional con formación y experiencia en el área te aportará las herramientas para analizar, comprender, modificar y ajustar tus procesos de comunicación, manejo de conflictos, toma de decisiones, solución de problemas y trato amoroso, desde diversos enfoques de la psicoterapia.
                </p>
            ),
                "Cancelar tu cita con anticipación nos permite utilizar ese horario para alguna persona que también lo necesite."
            ]
        ...
        },
        {
            ...
            description: [(
                <p>
                    Recomendamos que acudas a <span className="font-bold">Terapia de Pareja</span> para que ambos sean capaces de:
                </p>
            ),
            ['Mejorar la relación para alcanzar su potencial amoroso máximo.', 'Cumplir eficientemente con las tareas y metas según la etapa en que se encuentra la relación.', 'Renovar el amor y el cariño entre ambos.', 'Reafirmar la disposición y compromiso de seguir en la relación.', 'Disolver la relación en buenos términos cuando se hayan agotado todos los recursos emocionales.', 'Minimizar el impacto emocional en los hijos en caso de separación.']
            ]
        },
        {
        ...
        },
        {
            ...
            description: [(
                <p>
                    No te preocupes, aún puedes asistir a <span className="font-bold">Terapia Individual</span> como miembro de la pareja. Cuando se logra el cambio en uno de los miembros, la otra parte cambia en respuesta.
                </p>
            )]
        },
        {
    ...
    const beneficios = [
        {
            ...
            description: "La psicoterapia individual proporciona un entorno confidencial y de apoyo donde los pacientes pueden expresar abiertamente sus preocupaciones."
        },
        {
            photo: heart,
            title: "Mejora las relaciones interpersonales",
            description: "Explorar dinámicas personales mejora comunicación y fortalece relaciones para conexiones más saludables en lo personal y profesional."
        },
        {
            photo: heart,
            title: "Adaptación a cambios",
            description: "La psicoterapia brinda herramientas para adaptarse y gestionar cambios en la vida, construyendo resiliencia y capacidad de afrontamiento."
        },
    ]
    const beneficios2 = [
        {
            ...
            description: "La psicoterapia de pareja ofrece un espacio seguro para mejorar la comunicación, facilitando la expresión abierta y efectiva de pensamientos y emociones."
        },
        {
            photo: heart,
            title: "Resolución de Conflictos",
            description: "Ayuda a las parejas a identificar y abordar conflictos de manera constructiva, proporcionando estrategias para encontrar soluciones y llegar a compromisos mutuos."
        },
        {
            photo: heart,
            title: "Fortalecimiento de Vínculos",
            description: " Contribuye al fortalecimiento de la conexión emocional y afectiva entre las parejas, fomentando un entendimiento más profundo y una mayor intimidad."
        },
    ]
    return(
        <>
            <div className='flex flex-col items-center justify-center'>
                ...
                <div className='flex flex-col items-center justify-center px-4'>
                    <div className="pb-12 flex items-center justify-center mb-12 w-full gap-20 flex-wrap">
                        ...
                        <img src={pip8} alt="HOUSE" className='w-[500px] border-b-stone-600'/>
                    </div>
                ...
                <div className='w-full px-4 py-8 pt-20 mb-12 flex flex-col items-center justify-center pb-12 border-b border-gray-300'>
                    ...
                    <div className="flex flex-col justify-center items-center pb-32 mt-32 border-b border-gray">
                        ...
                        <div className="flex justify-center items-center flex-wrap gap-20">
                            <img src={pip7} alt="" className="w-[600px] mb-8"/>
